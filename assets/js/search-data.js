...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6D%69%63%61%65%6C%61%72%6F%74%68%31%30@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/micaelaroth", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/micaela-roth", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0009-0000-7329-8280", "_blank");
        },
      },{
        id: 'social-substack',
        title: 'Substack',
        section: 'Socials',
        handler: () => {
          window.open("https://substack.com/@gnuoyea", "_blank");
        },
      },{
      id: 'light-theme',
